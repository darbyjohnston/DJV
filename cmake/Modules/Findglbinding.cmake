...
elseif(APPLE)
    ...
    if(GLBINDING_SHARED_LIBS)
        if(CMAKE_BUILD_TYPE MATCHES "^Debug$")
            set(GLBINDING_LIBRARY ${CMAKE_INSTALL_PREFIX}/lib/libglbindingd.so)
            set(GLBINDING_AUX_LIBRARY ${CMAKE_INSTALL_PREFIX}/lib/libglbinding-auxd.so)
        else()
            set(GLBINDING_LIBRARY ${CMAKE_INSTALL_PREFIX}/lib/libglbinding.so)
            set(GLBINDING_AUX_LIBRARY ${CMAKE_INSTALL_PREFIX}/lib/libglbinding-aux.so)
        endif()
    else()
        if(CMAKE_BUILD_TYPE MATCHES "^Debug$")
            set(GLBINDING_LIBRARY ${CMAKE_INSTALL_PREFIX}/lib/libglbindingd.a)
