...
elseif(APPLE)
    ...
    set(RtAudio_INCLUDE_DIRS ${RtAudio_INCLUDE_DIRS} ${PULSE_INCLUDE_DIR} ${PULSESIMPLE_INCLUDE_DIR} ${JACK_INCLUDE_DIR})
    set(RtAudio_LIBRARIES ${RtAudio_LIBRARY} ${PULSE_LIB} ${PULSESIMPLE_LIB} ${JACK_LIB} ${ALSA_LIBRARY})
endif()
...
if(RtAudio_FOUND AND NOT TARGET RtAudio::RtAudio)
	...
	elseif(APPLE)
		set_property(TARGET RtAudio::RtAudio PROPERTY IMPORTED_LOCATION ${RtAudio_LIBRARY})
		set_property(TARGET RtAudio::RtAudio PROPERTY INTERFACE_LINK_LIBRARIES ${AUDIO_TOOLBOX} ${CORE_AUDIO})
		set_property(TARGET RtAudio::RtAudio PROPERTY INTERFACE_INCLUDE_DIRECTORIES ${RtAudio_INCLUDE_DIRS})
		set_property(TARGET RtAudio::RtAudio PROPERTY INTERFACE_COMPILE_DEFINITIONS RtAudio_FOUND)
	else()
		set_property(TARGET RtAudio::RtAudio PROPERTY IMPORTED_LOCATION ${RtAudio_LIBRARY})
		set_property(TARGET RtAudio::RtAudio PROPERTY INTERFACE_LINK_LIBRARIES ${PULSE_LIB} ${PULSESIMPLE_LIB} ${JACK_LIB} ${ALSA_LIBRARY})
		set_property(TARGET RtAudio::RtAudio PROPERTY INTERFACE_INCLUDE_DIRECTORIES ${RtAudio_INCLUDE_DIRS})
		set_property(TARGET RtAudio::RtAudio PROPERTY INTERFACE_COMPILE_DEFINITIONS RtAudio_FOUND)
	endif()
endif()
