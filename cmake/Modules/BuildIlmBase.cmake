...
if(CMAKE_BUILD_TYPE MATCHES "^Debug$")
    ...
    elseif(APPLE)
        ...
        set(ILMBASE_HALF_LIBRARY ${CMAKE_INSTALL_PREFIX}/lib/libHalf_s.a)
        set(ILMBASE_IEX_LIBRARY ${CMAKE_INSTALL_PREFIX}/lib/libIex_s.a)
        set(ILMBASE_IEXMATH_LIBRARY ${CMAKE_INSTALL_PREFIX}/lib/libIexMath_s.a)
        set(ILMBASE_ILMTHREAD_LIBRARY ${CMAKE_INSTALL_PREFIX}/lib/libIlmThread_s.a)
        set(ILMBASE_IMATH_LIBRARY ${CMAKE_INSTALL_PREFIX}/lib/libImath_s.a)
    endif()
else()
    if(WIN32)
    elseif(APPLE)
