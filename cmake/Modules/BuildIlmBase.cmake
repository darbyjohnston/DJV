...
if(CMAKE_BUILD_TYPE MATCHES "^Debug$")
    if(WIN32)
        ...
        set(ILMBASE_HALF_LIBRARY ${CMAKE_INSTALL_PREFIX}/lib/libHalf_s${CMAKE_STATIC_LIBRARY_SUFFIX})
        set(ILMBASE_IEX_LIBRARY ${CMAKE_INSTALL_PREFIX}/lib/libIex_s${CMAKE_STATIC_LIBRARY_SUFFIX})
        set(ILMBASE_IEXMATH_LIBRARY ${CMAKE_INSTALL_PREFIX}/lib/libIexMath_s${CMAKE_STATIC_LIBRARY_SUFFIX})
        set(ILMBASE_ILMTHREAD_LIBRARY ${CMAKE_INSTALL_PREFIX}/lib/libIlmThread_s${CMAKE_STATIC_LIBRARY_SUFFIX})
        set(ILMBASE_IMATH_LIBRARY ${CMAKE_INSTALL_PREFIX}/lib/libImath_s${CMAKE_STATIC_LIBRARY_SUFFIX})
    endif()
else()
    if(WIN32)
    else()
