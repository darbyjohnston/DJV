...
elseif (UNIX)
    ...
    if(DJV_THIRD_PARTY)
        ...
        set(DJV_RPM_PACKAGE_REQUIRES "libglvnd-glx")
        if(RtAudio_RPM_PACKAGE_REQUIRES)
            string(APPEND DJV_RPM_PACKAGE_REQUIRES ", " ${RtAudio_RPM_PACKAGE_REQUIRES})
        endif()
        set(CPACK_RPM_PACKAGE_REQUIRES ${DJV_RPM_PACKAGE_REQUIRES})
    endif()
    ...
    set(DJV_DEBIAN_PACKAGE_DEPENDS "libc6, libgcc1, libgl1")
    if(RtAudio_DEBIAN_PACKAGE_DEPENDS)
        string(APPEND DJV_DEBIAN_PACKAGE_DEPENDS ", " ${RtAudio_DEBIAN_PACKAGE_DEPENDS})
    endif()
    set(CPACK_DEBIAN_PACKAGE_DEPENDS ${DJV_DEBIAN_PACKAGE_DEPENDS})
