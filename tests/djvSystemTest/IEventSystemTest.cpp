...
namespace djv
{
    namespace SystemTest
    {
        ...
        protected:
            ...
            void _hover(System::Event::PointerMove&, std::shared_ptr<IObject>&) override;
        ...
        bool TestObject::event(System::Event::Event& event)
        {
        ...
        bool TestObject2::event(System::Event::Event& event)
        {
            bool out = IObject::event(event);
            if (!out)
            {
        ...
        void TestEventSystem::_init(System::Event::Init& event)
        {
            _initRecursive(_parent, event);
        }
        
        void TestEventSystem::_update(System::Event::Update& event)
        {
        ...
        void TestEventSystem::_hover(System::Event::PointerMove& event, std::shared_ptr<IObject>& hover)
        {
        ...
        IEventSystemTest::IEventSystemTest(
            ...
            const std::shared_ptr<Context>& context) :
            ITickTest("djv::SystemTest::IEventSystemTest", tempPath, context)
        {}
        ...
        void IEventSystemTest::_tick()
        {
            if (auto context = getContext().lock())
            {
                _pointerObserver = Observer::Value<Event::PointerInfo>::create(
                ...
                _hoverObserver = Observer::Value<std::shared_ptr<IObject> >::create(
                ...
                _grabObserver = Observer::Value<std::shared_ptr<IObject> >::create(
                    _system->observeGrab(),
                    [this](const std::shared_ptr<IObject>& value)
                    {
                        if (value)
                ...
                _keyGrabObserver = Observer::Value<std::shared_ptr<IObject> >::create(
                ...
                _textFocusActiveObserver = Observer::Value<bool>::create(
