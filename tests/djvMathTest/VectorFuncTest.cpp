...
namespace djv
{
    namespace MathTest
    {
        VectorFuncTest::VectorFuncTest(
            const System::File::Path& tempPath,
            const std::shared_ptr<System::Context>& context) :
            ITest("djv::MathTest::VectorFuncTest", tempPath, context)
        {}
        
        void VectorFuncTest::run()
        {
            _compare();
            _serialize();
            _hash();
        ...
        void VectorFuncTest::_serialize()
        {
            {
