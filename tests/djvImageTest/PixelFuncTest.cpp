...
namespace djv
{
    namespace ImageTest
    {
        PixelFuncTest::PixelFuncTest(
            const System::File::Path& tempPath,
            const std::shared_ptr<System::Context>& context) :
            ITest("djv::ImageTest::PixelFuncTest", tempPath, context)
        {}
        
        void PixelFuncTest::run()
        {
            _util();
            _convert();
            _serialize();
