    ...
    namespace AV
    {
        namespace Render2D
        {
            ...
            public:
                ...
                virtual void bind(const PrimitiveData&, const std::shared_ptr<OpenGL::Shader>&);
            };
            ...
            public:
                ...
                void bind(const PrimitiveData&, const std::shared_ptr<OpenGL::Shader>&) override;
            };
            ...
            Core::BBox2f flip(const Core::BBox2f&, const Image::Size&);
