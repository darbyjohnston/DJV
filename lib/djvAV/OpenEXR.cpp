...
namespace djv
{
    ...
    rapidjson::Value toJSON(const AV::OpenEXR::Options& value, rapidjson::Document::AllocatorType& allocator)
    {
    ...
    void fromJSON(const rapidjson::Value& value, AV::OpenEXR::Options& out)
    {
        if (value.IsObject())
        {
