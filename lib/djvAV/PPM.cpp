...
namespace djv
{
    ...
    rapidjson::Value toJSON(const AV::PPM::Options& value, rapidjson::Document::AllocatorType& allocator)
    {
    ...
    void fromJSON(const rapidjson::Value& value, AV::PPM::Options& out)
    {
        if (value.IsObject())
        {
