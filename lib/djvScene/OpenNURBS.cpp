...
namespace djv
{
    ...
    rapidjson::Value toJSON(const Scene::IO::OpenNURBS::Options& value, rapidjson::Document::AllocatorType&)
    {
    ...
    void fromJSON(const rapidjson::Value& value, Scene::IO::OpenNURBS::Options& out)
    {
        if (value.IsObject())
        {
        }
