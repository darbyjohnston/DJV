...
namespace djv
{
    namespace ViewApp
    {
        ...
        struct ViewWidget::Private
        {
            ...
            Math::BBox2f lockFrame = Math::BBox2f(0.F, 0.F, 0.F, 0.F);
        ...
        void ViewWidget::_init(const std::shared_ptr<System::Context>& context)
        {
        ...
        std::shared_ptr<ViewWidget> ViewWidget::create(const std::shared_ptr<System::Context>& context)
        {
        ...
        std::shared_ptr<IValueSubject<std::shared_ptr<Image::Image> > > ViewWidget::observeImage() const
        {
            return _p->image;
        }
        ...
        void ViewWidget::setImageFrame(const Math::BBox2f& value)
        {
            _p->lockFrame = value;
        }
