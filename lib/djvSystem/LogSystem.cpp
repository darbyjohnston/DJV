...
namespace djv
{
    namespace System
    {
        namespace
        {
            const std::string name = "djv::System::LogSystem";
        ...
        struct LogSystem::Private
        {
            ...
            std::shared_ptr<Timer> warningsAndErrorsTimer;
        };
        ...
        void LogSystem::_init(const std::shared_ptr<Context>& context)
        {
                ...
                [this]
            {
                ...
                log("djv::System::LogSystem", ss.str());

                const auto timeout = getTimerValue(TimerValue::Slow);
                while (p.running)
                {
                    {
            ...
            p.warningsAndErrorsTimer = Timer::create(context);
