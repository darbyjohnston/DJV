...
namespace djv
{
    namespace System
    {
        namespace File
        {
            ...
            void IO::open(const std::string& fileName, Mode mode)
            {
                close();
            ...
            bool IO::close(std::string* error)
            {
                bool out = true;
            ...
            void IO::read(void * in, size_t size, size_t wordSize)
            {
                if (!_f)
                {
            ...
            void IO::write(const void * in, size_t size, size_t wordSize)
            {
                if (!_f)
                {
            ...
            void IO::_setPos(size_t value, bool seek)
            {
                switch (_mode)
                {
                case Mode::Read:
