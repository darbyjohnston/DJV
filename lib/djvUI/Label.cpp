    ...
    namespace UI
    {
        namespace Text
        {
            ...
            void Label::_init(const std::shared_ptr<System::Context>& context)
            {
                ...
                setClassName("djv::UI::Text::Label");
            ...
            size_t Label::getTextElide() const
            {
                return _p->textElide;
            }
            ...
            void Label::setTextElide(size_t value)
            {
                DJV_PRIVATE_PTR();
            ...
            {
                DJV_PRIVATE_PTR();
                p.textSizeFuture = p.fontSystem->measure(p.text, p.fontInfo, p.textElide);
                if (!p.text.size())
                {
                    p.glyphs.clear();
                }
                p.glyphsFuture = p.fontSystem->getGlyphs(p.text, p.fontInfo, p.textElide);
            }
