...
namespace djv
{
    namespace UI
    {
        namespace Numeric
        {
            ...
            {
                ISlider<float>::_pointerMove(pos, getDelay());
            }

            void BasicFloatSlider::_buttonPress(float pos)
            {
                ISlider<float>::_buttonPress(pos, getDelay());
            }

            void BasicFloatSlider::_buttonRelease()
            {
                ISlider<float>::_buttonRelease(getDelay());
            }

            bool BasicFloatSlider::_keyPress(int key)
            {
                return ISlider<float>::_doKeyPress(glfwToKey(key));
            }
