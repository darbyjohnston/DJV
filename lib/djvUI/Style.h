    ...
    namespace UI
    {
        ...
        namespace Style
        {
            ...
            private:
                ...
                std::shared_ptr<Core::Observer::Value<UI::Style::Palette> > _paletteObserver;
                std::shared_ptr<Core::Observer::Value<float> > _brightnessObserver;
                std::shared_ptr<Core::Observer::Value<float> > _contrastObserver;
                std::shared_ptr<Core::Observer::Value<UI::Style::Metrics> > _metricsObserver;
                std::shared_ptr<Core::Observer::Value<std::string> > _fontObserver;
                std::shared_ptr<Core::Observer::Map<Render2D::Font::FamilyID, std::string> > _fontNamesObserver;
                std::shared_ptr<Core::Observer::Map<Render2D::Font::FamilyID, std::map<Render2D::Font::FaceID, std::string> > > _fontFacesObserver;
