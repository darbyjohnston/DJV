...
namespace djv
{
    ...
    rapidjson::Value toJSON(const Scene3D::IO::OpenNURBS::Options& value, rapidjson::Document::AllocatorType&)
    {
    ...
    void fromJSON(const rapidjson::Value& value, Scene3D::IO::OpenNURBS::Options& out)
    {
        if (value.IsObject())
        {
        }
