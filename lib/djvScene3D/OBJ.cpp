...
namespace djv
{
    ...
    rapidjson::Value toJSON(const Scene3D::IO::OBJ::Options& value, rapidjson::Document::AllocatorType&)
    {
    ...
    void fromJSON(const rapidjson::Value& value, Scene3D::IO::OBJ::Options& out)
    {
        if (value.IsObject())
        {
        }
