...
namespace djv
{
    ...
    rapidjson::Value toJSON(const Scene3D::IO::OpenNURBS::Options&, rapidjson::Document::AllocatorType&);

    //! Throws:
    //! - std::exception
    void fromJSON(const rapidjson::Value&, Scene3D::IO::OpenNURBS::Options&);
