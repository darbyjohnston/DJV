...
void FFmpegIO::_work(const System::File::Info& info)
{
    try
    {
...
int FFmpegIO::_decodeVideo(const DecodeVideo& dv, Math::Frame::Number& frame)
{
...
int FFmpegIO::_decodeAudio(const DecodeAudio& da, Math::Frame::Number& frame)
{
